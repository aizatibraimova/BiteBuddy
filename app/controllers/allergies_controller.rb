class AllergiesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @allergy.save
        format.html { redirect_to allergy_url(@allergy), notice: "Allergy was successfully created." }
  ...
  def update
    respond_to do |format|
      if @allergy.update(allergy_params)
        format.html { redirect_to allergy_url(@allergy), notice: "Allergy was successfully updated." }
  ...
  private
    ...
    def allergy_params
      params.require(:allergy).permit(:description, :severity, :detected_date, :notes, :child_id)
    end
end
